...
public class Message {
    ...
    public static final String GAME_START = "Nimto Start!!";
    public static final String INPUT_NUMBER_ERROR = "整数を入力してください";
    public static final String CANNOT_PLACE_CARD_WITH_SMALL_NUMBER = "数が小さすぎるため、配置することができませんでした";
